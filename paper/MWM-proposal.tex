...
\textbf{Multimodal integration.} Language is the first modality. Images, audio, sensor data come next. How are they embedded? How do they connect to text nodes? Is a unified multimodal embedding space (SONAR-style) the right substrate, or should modalities stay separate and connect only through text descriptions?
