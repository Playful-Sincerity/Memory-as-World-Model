...
\section{8. The Search for a Unified Substrate}\label{the-search-for-a-unified-substrate}
...
\subsection{8.1 Why it has to be unified}\label{why-it-has-to-be-unified}
...
\subsection{8.2 What it isn't}\label{what-it-isnt}
...
\subsection{8.3 The open research questions}\label{the-open-research-questions}
...
\section{10. A Note on Framing}\label{a-note-on-framing}
